...
def run_test_sum_sequence():
    ...
    # ------------------------------------------------------------------
    # COMPLETED: 2. READ the COMMENTS and CODE in this function,
...
def run_test_count_positive_sines():
    ...
    # Test 11:
    expected = 2
    actual = count_positive_sines([4, 5, 8, 20, 31])
    print()
...
def run_test_sum_first_n():
    ...
    # Test 8:
    expected = 80
    actual = sum_first_n([20, 20, 20, 20], 4)
    print()
    print('Test 8 expected:', expected)
    print('       actual:  ', actual)
    ...
    # Test 9:
    expected = 30
    actual = sum_first_n([5, 10, 15, 20, 25, 30], 3)
    print()
    print('Test 9 expected:', expected)
    print('       actual:  ', actual)
